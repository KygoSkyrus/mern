...
const BannerSlider = () => {
  const settings = {
    ...
    autoplay: true,
    autoplaySpeed: 2500,
    cssEase: "linear", // to keep playing automatically
        ...
        <Slider {...settings}>
          <div className="slide slide1">
            <div className="xbox-content text-light">
              ...
              <p>
                <span>Like You, We Love Music</span> And we believe a Headphone
                is more than just an instrument for sound. It’s the key to a
                mind-blowing moment of emotion, bringing you closer to your
                favourite artist, and yourself.
              </p>
              <a
          ...
          <div className="slide slide4">
            <div className="xbox-content text-light">
              <h2>
                <i className="fa-brands fa-apple me-2"></i>iPhone 13 Pro
              </h2>
              <p>
              ...
              <a
                href="/product/64c68fbe2dd4e9cac1dcf1d7"
                className="xbox-btn"
                target="blank"
              >
                Explore
            ...
            <img src={iphone4} alt="shoppitt" width="100%" />
          </div>
          <div className="slide slide2">
            ...
            <img src={laptop1} alt="shoppitt" width="100%" />
          </div>
          <div className="slide slide3">
            <div className="xbox-content text-light">
              ...
              <a
                href="/product/64c9e48a9512ccd6d6ac28b8"
                className="xbox-btn"
                target="blank"
              >
                Explore Now
