...
const SignInForm = ({ userCredentials, setUserCredentials, title, description, toggleText, signInOrSignUp, toggleSignInOrSignUp, btnText }) => {
    ...
    return (
        <>
            ...
            <button className='btn btn-outline-info w-100 m-2 d-flex justify-content-center align-items-center fs-5 text-black-50 py-1' onClick={() => goWithGoogle(signInOrSignUp, navigate, dispatch)}>
