...
console.log(e.target.style['background-image'])
console.log(e.target.firstChild)

e.target.firstChild.classList.add('display-block')
e.target.firstChild.style.backgroundImage=e.target.style['background-image']//placing the same image to the hover preview

    }
    const hideImagePreview=(e)=>{
        console.log('background-image')
        
        e.target.firstChild.classList.remove('display-block')
...
<td className="align-middle">
    ...
    <div className="d-inline-flex">                  
        ...
        <div className="avatars__item pointer" onMouseOver={(e)=>imagePreview(e)} onMouseOut={(e)=>hideImagePreview(e)} style={{ background: `url(${okayIcon})`, backgroundSize: "contain", backgroundPosition: "center", backgroundRepeat: "no-repeat",position:"relative" }}>
